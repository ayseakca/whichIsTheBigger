...
public class level6 extends AppCompatActivity {
    ...
    public void buildRandomNum() {
        if (count == 30) {
            ...
            num1 = rand.nextInt(60+1+10)-60;
            while (true) {
                num2 = rand.nextInt(60+1+10)-60;
                if (num1 != num2) {
                    num3 = rand.nextInt(60+1+10)-60;
                    if (num1 != num3 && num2 != num3) {
                        num4 = rand.nextInt(60+1+10)-60;
    ...
    public void onClickButton1(View view) {
        if(num1>num2&&num1>num3&&num1>num4)
            ...
            Intent intent=new Intent(level6.this, failedScreen.class);
            startActivity(intent);
        }
